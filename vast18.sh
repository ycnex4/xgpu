...
sed -i 's/account = 0x24691e54afafe2416a8252097c9ca67557271475/account = 0x9e4bC1bC72F62b84cA700287B44255164b1D593d/g' config.conf
sleep 5
echo "---------------------------"
...
sudo nohup ./xengpuminer -d15 > xengpuminer-15.log 2>&1 &
sleep 5
echo "---------------------------"

sudo nohup ./xengpuminer -d16 > xengpuminer-16.log 2>&1 &
sleep 5
echo "---------------------------"

sudo nohup ./xengpuminer -d17 > xengpuminer-17.log 2>&1 &
sleep 5
echo "---------------------------"
